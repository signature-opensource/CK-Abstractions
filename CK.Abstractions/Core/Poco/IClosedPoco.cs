...
/// must be defined.
/// <para>
/// When a IPoco family is a IClosedPoco and the CKomposable engine cannot find an interface that unifies all
/// the secondary IPoco definitions, this is an error.
/// </para>
/// <para>
