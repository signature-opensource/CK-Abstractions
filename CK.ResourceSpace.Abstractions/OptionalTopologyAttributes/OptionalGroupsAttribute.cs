...
/// type belongs IF the child type belongs to the package selection.
/// Each string can be a single package full name or comma separated multiple
/// package full names. 
/// <para>
/// The typed attributes (<see cref="OptionalGroupsAttribute{T}"/>, ..., <see cref="OptionalGroupsAttribute{T1, T2, T3, T4, T5, T6}"/>)
/// should be preferred when the types of the groups are accessible.
/// </para>
/// </summary>
[AttributeUsage( AttributeTargets.Class, AllowMultiple = true, Inherited = false )]
public sealed class OptionalGroupsAttribute : Attribute
{
    /// <summary>
